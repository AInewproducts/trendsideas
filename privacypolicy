...
木子互动非常重视用户的隐私保护。《营销创意王》(以下简称“本软件”)由木子互动开发并运营。我们深知个人信息对用户的重要性,会采取一切合理可行的措施,努力保护您的个人信息安全可靠。我们希望您在使用本软件的过程中,了解我们在信息收集、使用方面的政策和实践。本隐私政策解释了我们在您使用本软件时如何收集、使用您的个人信息。  
